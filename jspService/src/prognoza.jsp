  ...
  <% 
    ...
    if (elements[0].equals("users")) {
      if (elements[1].equals("login")) {
        ...
        out.println(prog.getUsersByProg(elements[2]));
      } else {
        out.println("Invalid.");
      }
      ...
      if (elements[1].equals("add")) {
        ...
        out.println(prog.updatePrognoza(elements[2], elements[3], elements[4], elements[5], elements[6], elements[7], elements[8], elements[9], elements[10], elements[11], elements[12]));
        ...
        out.println(prog.getPrognozaByCity(elements[2]);
      }
      else {
        out.println("Invalid.");
      }
